    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-lg-6 col-sm-12">
                <div class="white-box">
                    <h3 class="box-title">Chỉnh sửa biến thể sản phẩm</h3>
                    ...
                    <form action="{{ route('variants.update', $variant->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="product_name" id="product_name" class="form-control"
                                ...
                                value="{{ old('product_name', $variant->product->name) }}">
                            <input type="hidden" name="product_id" id="product_id"
                                value="{{ old('product_id', $variant->product_id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="size" id="size" class="form-control">
                                ...
                                @foreach (['S', 'M', 'L', 'XL', 'XXL'] as $s)
                                    <option value="{{ $s }}"
                                        {{ old('size', $variant->size) == $s ? 'selected' : '' }}>
                                        {{ $s }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="color" id="color" class="form-control"
                                placeholder="Nhập màu sắc" value="{{ old('color', $variant->color) }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="stock" id="stock" class="form-control"
                                placeholder="Nhập số lượng" value="{{ old('stock', $variant->stock) }}">
                        </div>
